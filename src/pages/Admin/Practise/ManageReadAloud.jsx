...
const ManageReadAloud = () => {
    ...
    const openEditModal = (q) => {
        setForm({
            ...
            text: q.text || '' // Added for Read Aloud
        });
        setEditingId(q._id);
        setOpenModal(true);
    };
        ...
        <AdminLayout>
            <div className="p-8 bg-[#f8fafc] min-h-screen">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900">Manage Read Aloud</h1>
                        <p className="text-slate-500 mt-1">Add, edit, or remove Read Aloud practice questions</p>
                    </div>
                    <motion.button
                        ...
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                            ...
                            >
                                ...
                                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-1">Question Name</label>
                                        <input
                                    ...
                                    <div className="relative group">
                                        ...
                                        >
                                            ...
                                            <span className="text-sm font-medium text-slate-600">
                                                {form.audio ? form.audio.name : 'Click to upload audio (optional)'}
                                            </span>
                            ...
                            >
                                ...
                                <div className="p-8 space-y-6">
                                    <div className="space-y-2">
                                        <span className="text-indigo-400 text-sm font-bold tracking-widest uppercase">Preview Read Aloud Question</span>
                                    ...
                                    {viewData.text && (
                                        <div className="space-y-3">
                                            <h4 className="font-semibold text-slate-300">Text to Read</h4>
